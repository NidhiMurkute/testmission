...
module.exports = cds.service.impl(async function () {
    ...
    bupaSrv.on(['BusinessPartnerCreated', 'tfe/bpem/em/sap/s4/beh/businesspartner/v1/BusinessPartner/Created/v1','tfe/bpem/em/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/*','tfe/bpem/em/sap/s4/beh/businesspartner/v1/BusinessPartner/*'],  async (msg, req) => {
         console.log("<< BusinessPartnerCreated event caught")
        try {
